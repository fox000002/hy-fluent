...
/* TOTAL_SMP_POINTS from config.h */
...
static int g_nReadInput = 0;

static real g_pos_x[DX_SIZE];
static real g_Ma[DX_SIZE];
static real g_Ts[DX_SIZE];
static real g_Ps[DX_SIZE];
static real g_Gamma[DX_SIZE];
static real g_Mol_Weight[DX_SIZE];
